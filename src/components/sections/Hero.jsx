...
import { BsGithub as BsGit, BsLinkedin as BsLin, BsTwitterX as BsTw, BsArrowDownShort as BsArrowDownS } from "react-icons/bs";
        ...
        <div className="flex sm:w-full flex-col-reverse sm:flex-row relative justify-between items-center gap-10 sm:gap-6">
            ...
            <div className="flex flex-wrap gap-4 mt-6 sm:mt-8">
              <a href="#contact">
                <motion.button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 flex gap-2 items-center justify-center font-bold rounded-xl shadow-lg shadow-blue-500/20 transition-all duration-300 text-[15px] cursor-pointer"
                >
              ...
              <a href="#portfolio">
                <motion.button
                  whileTap={{ scale: 0.96 }}
                  whileHover={{ scale: 1.03 }}
                  className={`px-6 py-3.5 flex gap-2 items-center justify-center font-bold rounded-xl border transition-all duration-300 text-[15px] cursor-pointer ${
                    darkmode
          ...
          >
            <motion.div
              ...
              className={`box sm:h-[300px] h-[200px] sm:w-[300px] w-[200px] bg-gradient-to-tr ${
                darkmode
          ...
          <a href="#about" className="absolute -bottom-[80px] left-0 hidden sm:block">
            ...
            >
              ...
              <BsArrowDownS size={20} className="mt-0.5" />
            </motion.div>
          </a>
        </div>
      </div>
