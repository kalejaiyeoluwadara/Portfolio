...
import img from "/dara_memoji.png";
import {
  BsGithub,
  BsLinkedin,
  BsTwitterX,
      ...
      <div className="flex relative items-center justify-center gap-8 sm:gap-[100px] lg:gap-[140px] sm:px-0 px-6 w-[90%] sm:w-[80%] flex-col sm:flex-row">
        ...
        >
          <a
            ...
            aria-label="GitHub"
            className={`w-10 h-10 rounded-full flex items-center justify-center border transition-all duration-300 hover:scale-110 active:scale-95 shadow-sm ${darkmode
        ...
        <div className="flex sm:w-full flex-col-reverse sm:flex-row relative justify-between items-center gap-10 sm:gap-6">
          ...
          <div className="flex sm:w-[480px] w-full flex-col gap-4 mt-6">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2 select-none">
              <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider ${darkmode
            ...
            <div>
              <h1
                className={`font-bold sm:text-[50px] text-[33px] leading-tight tracking-tight ${darkmode ? "text-white" : "text-gray-900"
                  }`}
              >
            ...
            {/* Description */}
            <p
              className={`w-full sm:w-[450px] text-[15px] sm:text-[16px] leading-relaxed font-medium ${darkmode ? "text-slate-300" : "text-slate-600"
                }`}
            >
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {["React", "Next.js", "Node.js", "Express", "Tailwind CSS", "MongoDB"].map((tech) => (
                <span
                  key={tech}
                  className={`text-xs font-semibold px-2.5 py-1 rounded-md border select-none ${darkmode
            ...
            <div className="flex flex-wrap gap-4 mt-6 sm:mt-8">
              ...
              <a href="#portfolio">
                <motion.button
                  whileTap={{ scale: 0.96 }}
                  whileHover={{ scale: 1.03 }}
                  className={`px-6 py-3.5 flex gap-2 items-center justify-center font-bold rounded-xl border transition-all duration-300 text-[15px] ${darkmode
          ...
          <a href="#about" className="absolute -bottom-[80px] left-0 hidden sm:block">
            <motion.div
              ...
              className={`flex items-center gap-1.5 cursor-pointer duration-300 text-sm font-semibold select-none ${darkmode ? "text-slate-400 hover:text-indigo-400" : "text-slate-500 hover:text-blue-600"
                }`}
            >
